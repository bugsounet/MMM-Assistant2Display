...
Hotword_CheckSB() {
  Hotword_err="0"
  Hotword_chk_index="$(ls ~/MagicMirror/modules/MMM-Assistant2Display/snowboy/lib/node/index.js | grep index)"
  Hotword_chk_node="$(ls ~/MagicMirror/modules/MMM-Assistant2Display/snowboy/lib/node/binding/Release | grep node)"
  Hotword_chk_electron="$(ls ~/MagicMirror/modules/MMM-Assistant2Display/snowboy/lib/node/binding/Release | grep electron)"
