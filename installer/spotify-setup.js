...
for (let [nb, module] of Object.entries(MMModules)) {
  if (module.module == "MMM-Assistant2Display") {
    found = true
    if (!module.config.spotify) return console.log("spotify module not configured in config.js")
    if (!module.config.spotify.TOKEN) return console.log("TOKEN is not defined in spotify module !")
    ...
    /** All is Good ! **/
    config.TOKEN = module.config.spotify.TOKEN
